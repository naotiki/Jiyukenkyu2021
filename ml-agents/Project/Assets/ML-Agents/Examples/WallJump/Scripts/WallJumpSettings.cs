...
{
    [Header("Specific to WallJump")] public float agentRunSpeed;
    ...
    [HideInInspector] public float agentJumpVelocity = 777;
    [HideInInspector] public float agentJumpVelocityMaxChange = 10;
}
